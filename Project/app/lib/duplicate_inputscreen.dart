                ...
                child: Row(
                  children: <Widget>[
                    ...
                    Container(
                      width: 250,
                      child: Slider(
                        value: edit ? detail.age.toDouble() : age.toDouble(),
                        min: 0,
                        max: 100,
                        divisions: 101,
                    ...
                    Text(
                      edit ? detail.age.toString() : age.toString(),
              ...
              Container(
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    Radio(
                      value: 1,
                      groupValue: edit ? detail.sex.toInt() : sex,
                      onChanged: (value) {
                        setState(() {
                          sex = value;
                          // print(sex);
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    Container(
                      width: 138,
                      child: TextFormField(
                        initialValue: edit ? detail.restingBP.toString() : null,
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: TextFormField(
                          initialValue:
                              edit ? detail.cholesterol.toString() : null,
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: TextFormField(
                        initialValue:
                            edit ? detail.fastingBSTemp.toString() : null,
              ...
              Container(
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    Radio(
                      value: 1,
                      groupValue: edit ? detail.restingECG : restingECG,
                      onChanged: (value) {
                        setState(() {
                          restingECG = value;
                          // print(sex);
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: TextFormField(
                        ...
                        initialValue: edit ? detail.maxHR.toString() : null,
                        validator: (val) =>
                            val!.isEmpty ? 'Please enter a value' : null,
                        onChanged: (val) =>
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    Radio(
                      value: 1,
                      groupValue:
                          edit ? detail.exerciseAngina.toInt() : exerciseAngina,
                      onChanged: (value) {
                        setState(() {
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: TextFormField(
                        decoration: decorationfunction('--'),
                        initialValue: edit ? detail.oldpeak.toString() : null,
              ...
              Container(
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    Radio(
                      value: 2,
                      groupValue: edit ? detail.stSlope : stSlope,
                      onChanged: (value) {
                        setState(() {
                          stSlope = value;
                          // print(sex);
